...
final class RecipesRoller {
    ...
    private static void registerRecipes() {
        RollerRecipes.rolling().addRolling(EnumToItemStack.getItemIS(EnumItem.sheetAluminum), EnumToItemStack.getItemIS(EnumItem.foilAluminum));
        RollerRecipes.rolling().addRolling(EnumToItemStack.getItemIS(EnumItem.sheetGold), EnumToItemStack.getItemIS(EnumItem.foilGold));
        RollerRecipes.rolling().addRolling(EnumToItemStack.getItemIS(EnumItem.ingotAluminum), EnumToItemStack.getItemIS(EnumItem.sheetAluminum));
        ...
        // EHandler.getItem(EnumBaseItem.sheetAluminum));
        RollerRecipes.rolling().addRolling(new ItemStack(Item.ingotGold), EnumToItemStack.getItemIS(EnumItem.sheetGold));
        RollerRecipes.rolling().addRolling(new ItemStack(Item.ingotIron), EnumToItemStack.getItemIS(EnumItem.sheetIron));
        ...
        RollerRecipes.rolling().addRolling(EnumToItemStack.getItemIS(EnumItem.globDough), EnumToItemStack.getItemIS(EnumItemSixteen.rawPizza));
        RollerRecipes.rolling().addRolling(EnumToItemStack.getItemIS(EnumItem.globDoughCorn), EnumToItemStack.getItemIS(EnumUncookedFood.uncookedTortilla));
