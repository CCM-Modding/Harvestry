...
final class RecipesRoller {
	...
	private void registerRecipes() {
		RollerRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumItem.sheetAluminum),
											EnumToItemStack.getItemIS(EnumItem.foilAluminum));
		RollerRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumItem.sheetGold),
											EnumToItemStack.getItemIS(EnumItem.foilGold));
		RollerRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumItem.ingotAluminum),
		...
		// EHandler.getItem(EnumBaseItem.sheetAluminum));
		RollerRecipes.instance().addRecipe(	new ItemStack(Item.ingotGold),
											EnumToItemStack.getItemIS(EnumItem.sheetGold));
		RollerRecipes.instance().addRecipe(	new ItemStack(Item.ingotIron),
		...
		RollerRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumItem.globDough),
											EnumToItemStack.getItemIS(EnumItemSixteen.rawPizza));
		RollerRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumItem.globDoughCorn),
											EnumToItemStack.getItemIS(EnumUncookedFood.uncookedTortilla));
		RollerRecipes.instance().addRecipe(	new ItemStack(ModItems.toolShovel),
											new ItemStack(ModItems.toolFlatShovel));
		RollerRecipes.instance().addRecipe(	new ItemStack(Item.shovelWood),
											new ItemStack(ModItems.toolFlatShovelWood));
		RollerRecipes.instance().addRecipe(	new ItemStack(Item.shovelStone),
											new ItemStack(ModItems.toolFlatShovelStone));
		RollerRecipes.instance().addRecipe(	new ItemStack(Item.shovelIron),
											new ItemStack(ModItems.toolFlatShovelIron));
		RollerRecipes.instance().addRecipe(	new ItemStack(Item.shovelDiamond),
											new ItemStack(ModItems.toolFlatShovelDiamond));
		RollerRecipes.instance().addRecipe(	new ItemStack(Item.shovelGold),
