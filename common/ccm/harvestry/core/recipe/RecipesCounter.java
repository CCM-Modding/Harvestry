...
final class RecipesCounter
{
    ...
    {
        CounterRecipes.cutting().addCutting(Item.bread, EnumHelper.getItemIS(EnumItem.sliceBread, 6));
        CounterRecipes.cutting().addCutting(EnumHelper.getItemIS(EnumItem.itemOnion), EnumHelper.getItemIS(EnumItem.sliceOnion, 3));
        CounterRecipes.cutting().addCutting(EnumHelper.getItemIS(EnumFood.foodTomato), EnumHelper.getItemIS(EnumItem.sliceTomato, 3));
        CounterRecipes.cutting().addCutting(EnumHelper.getItemIS(EnumFood.foodCheese), EnumHelper.getItemIS(EnumItem.sliceCheese, 6));
