...
final class RecipesCrafting {
	...
	private static void addShaped() {
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(	EnumToItemStack.getItemIS(	EnumItemSixteen.bottlePitcher,
																				2),
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(	EnumToItemStack.getItemIS(	EnumUncookedFood.uncookedMeatBall,
																				4),
													new Object[] { "MM",
															"MM",
															'M',
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(	EnumToItemStack.getItemIS(	EnumUncookedFood.uncookedMeatPatty,
																				2),
													new Object[] { "MMM",
															'M',
															EnumToItemStack.getItemIS(EnumItem.dustBeef) }));
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(EnumToItemStack.getItemIS(	EnumUncookedFood.uncookedNoodles,
																			3), new Object[] { "D",
								"G",
								'D',
								EnumToItemStack.getItemIS(EnumItem.globDough),
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(	EnumToItemStack.getItemIS(	EnumFood.foodSandwichChickenFried,
																				2),
													new Object[] { "BB",
															"CL",
															"BB",
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(new ItemStack(Item.paper, 5), new Object[] { "WWW",
								'W',
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(	new ItemStack(ModItems.toolCuttingBoard),
													new Object[] { "WWW", "WWW", 'W', "plankWood" }));
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapedOreRecipe(new ItemStack(ModItems.toolClippers), new Object[] { " I ",
								"S I",
								" S ",
								'S',
								"stickWood",
	...
	private static void addShapeless() {
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapelessOreRecipe(new ItemStack(ModItems.grindStones),
		...
		CraftingManager.getInstance()
						.getRecipeList()
						.add(new ShapelessOreRecipe(new ItemStack(Item.dyePowder, 4, 15),
													new Object[] { Item.bone, RecipesCrafting.grindStones }));
		// Uncondensed Items
		CraftingManager.getInstance()
						.getRecipeList()
