...
final class RecipesCrafting
{
    ...
    private static void addShaped()
    {
        ...
        { " S ", "S S", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetIron) }));
        ...
        { " S ", "S S", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.heTin), new Object[]
        { " S ", "S S", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetTin) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.heCopper), new Object[]
        { " S ", "STS", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetCopper), 'T', new ItemStack(ModItems.heTin) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.heIron), new Object[]
        { " S ", "SAS", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetIron), 'A', new ItemStack(ModItems.heAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.heBronze), new Object[]
        { " S ", "SIS", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetBronze), 'I', new ItemStack(ModItems.heIron) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.heGold), new Object[]
        { " S ", "SIS", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetGold), 'I', new ItemStack(ModItems.heIron) }));
        // Cooking Items
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.panBread), new Object[]
        { " T ", "T T", " T ", 'T', EHandler.getItem(EnumBaseItem.sheetAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.panCake), new Object[]
        { "T T", "T T", "TTT", 'T', EHandler.getItem(EnumBaseItem.sheetAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.panPie), new Object[]
        { "T T", "TTT", 'T', EHandler.getItem(EnumBaseItem.sheetAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.panPieCrust), new Object[]
        { "B", "P", 'B', EHandler.getItem(EnumBaseItem.globDough), 'P', EHandler.getItem(EnumNonStack.panPie) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bowl), new Object[]
        { "T T", " T ", 'T', EHandler.getItem(EnumBaseItem.sheetAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.sheetCookie), new Object[]
        { "TTT", "TTT", 'T', EHandler.getItem(EnumBaseItem.sheetAluminum) }));

        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottle, 5), new Object[]
        { " G ", "G G", "GGG", 'G', Block.thinGlass })); // Can hold 800mb any juice
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottleGlass, 4), new Object[]
        { "G G", "G G", 'G', Block.thinGlass })); // Can hold 500mb any juice
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottleMilk, 3), new Object[]
        { " G ", "G G", " G ", 'G', Block.thinGlass })); // Can hold 800mb only milk
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottlePitcher, 2), new Object[]
        { "G G", "G G", "GGG", 'G', Block.thinGlass })); // Can hold 1000mb any juice

        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseItem.itemKetchup), new Object[]
        { "T", "B", 'T', EHandler.getItem(EnumNonStack.globTomato), 'B', EHandler.getItem(EnumNonStack.bottle) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseItem.itemMustard), new Object[]
        { "M", "B", 'M', EHandler.getItem(EnumNonStack.rawMustard), 'B', EHandler.getItem(EnumNonStack.bottle) }));
        // Uncooked Food
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedCake), new Object[]
        { "B", "P", 'B', EHandler.getItem(EnumNonStack.bowlBatter), 'P', EHandler.getItem(EnumNonStack.panCake) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPotato), new Object[]
        { "P", "F", 'P', Item.potato, 'F', EHandler.getItem(EnumBaseItem.foilAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedBread), new Object[]
        { "D", "P", 'D', EHandler.getItem(EnumBaseItem.globDough), 'P', EHandler.getItem(EnumNonStack.panBread) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedCookies), new Object[]
        { "C", "P", 'C', EHandler.getItem(EnumNonStack.bowlCookieDough), 'P', EHandler.getItem(EnumNonStack.sheetCookie) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedCookiesChocolateChip), new Object[]
        { "C", "P", 'C', EHandler.getItem(EnumNonStack.bowlCookieDoughChocolateChip), 'P', EHandler.getItem(EnumNonStack.sheetCookie) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedCookiesSugar), new Object[]
        { "C", "P", 'C', EHandler.getItem(EnumNonStack.bowlCookieDoughSugar), 'P', EHandler.getItem(EnumNonStack.sheetCookie) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPiePumpkin), new Object[]
        { "F", "P", 'F', EHandler.getItem(EnumNonStack.bowlPumpkinFilling), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPieApple), new Object[]
        { "AAA", " P ", 'A', EHandler.getItem(EnumBaseItem.sliceApple), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPieBerryBlue), new Object[]
        { "BBB", " P ", 'B', EHandler.getItem(EnumBaseFood.foodBerryBlue), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPieBerryCherry), new Object[]
        { "CCC", " P ", 'C', EHandler.getItem(EnumBaseFood.foodBerryCherry), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPizzaCheese), new Object[]
        { "C", "P", 'C', EHandler.getItem(EnumBaseItem.dustCheese), 'P', EHandler.getItem(EnumNonStack.rawPizzaSauce) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedMeatBall, 4), new Object[]
        { "MM", "MM", 'M', EHandler.getItem(EnumBaseItem.dustBeef) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedMeatPatty, 2), new Object[]
        { "MMM", 'M', EHandler.getItem(EnumBaseItem.dustBeef) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedNoodles, 3), new Object[]
        { "D", "G", 'D', EHandler.getItem(EnumBaseItem.globDough), 'G', ModItems.toolGrate }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.rawPizzaSauce), new Object[]
        { "T", "P", 'T', EHandler.getItem(EnumNonStack.globTomato), 'P', EHandler.getItem(EnumNonStack.rawPizza) }));
        // Food
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSandwichCheese, 4), new Object[]
        { "BBB", "CCC", "BBB", 'B', EHandler.getItem(EnumBaseItem.sliceBread), 'C', EHandler.getItem(EnumBaseItem.dustCheese) }));
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSandwichHam, 4), new Object[]
                {
                                "BBB",
                                "LHC",
                                "BBB",
                                'B',
                                EHandler.getItem(EnumBaseItem.sliceBread),
                                'C',
                                EHandler.getItem(EnumBaseItem.dustCheese),
                                'H',
                                Item.porkRaw,
                                'L',
                                EHandler.getItem(EnumNonStack.itemLettuceLeaf) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSandwichPB_J, 4), new Object[]
        { "B B", "P J", "B B", 'B', EHandler.getItem(EnumBaseItem.sliceBread), 'P', EHandler.getItem(EnumNonStack.globPB), 'J', EHandler.getItem(EnumNonStack.globJelly) }));
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodHamburger, 3), new Object[]
                {
                                "TBC",
                                "MPK",
                                "LBO",
                                ...
                                EHandler.getItem(EnumBaseItem.dustCheese),
                                'O',
                                EHandler.getItem(EnumBaseItem.sliceOnion),
                                'T',
                                EHandler.getItem(EnumBaseItem.sliceTomato),
                                'L',
                                EHandler.getItem(EnumNonStack.itemLettuceLeaf),
                                'P',
                                EHandler.getItem(EnumNonStack.cookedMeatPatty),
                                'M',
                                EHandler.getItem(EnumBaseItem.itemMustard),
                                'K',
                                EHandler.getItem(EnumBaseItem.itemKetchup) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodBagOChips, 4), new Object[]
        { "ASA", "CCC", "ACA", 'A', EHandler.getItem(EnumBaseItem.sheetAluminum), 'C', EHandler.getItem(EnumNonStack.friedChips), 'S', EHandler.getItem(EnumBaseItem.dustSalt) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodBoxOFries, 4), new Object[]
        { "FSF", "PFP", " P ", 'P', Item.paper, 'F', EHandler.getItem(EnumNonStack.friedFries), 'S', EHandler.getItem(EnumBaseItem.dustSalt) }));
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodTaco, 2), new Object[]
                {
                                "MLC",
                                " T ",
                                'T',
                                EHandler.getItem(EnumNonStack.itemTaco),
                                'M',
                                EHandler.getItem(EnumNonStack.cookedDustMeat),
                                'L',
                                EHandler.getItem(EnumNonStack.itemLettuceLeaf),
                                'C',
                                EHandler.getItem(EnumBaseItem.dustCheese) }));
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodBurito, 2), new Object[]
                {
                                "MLC",
                                " T ",
                                'T',
                                EHandler.getItem(EnumNonStack.itemTortilla),
                                'M',
                                EHandler.getItem(EnumNonStack.cookedDustMeat),
                                'L',
                                EHandler.getItem(EnumNonStack.itemLettuceLeaf),
        ...
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSpaghetti, 3), new Object[]
                {
                                "MMM",
                                "SSS",
                                "NNN",
                                'M',
                                EHandler.getItem(EnumNonStack.cookedMeatBall),
                                'N',
                                EHandler.getItem(EnumNonStack.cookedNoodles),
                                'T',
                                EHandler.getItem(EnumNonStack.globTomato) }));
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSandwichChickenFried, 2), new Object[]
                {
                                "BB",
                                "CL",
                                "BB",
                                ...
                                EHandler.getItem(EnumBaseItem.sliceBread),
                                'C',
                                EHandler.getItem(EnumBaseFood.foodChickenFried),
                                'L',
                                EHandler.getItem(EnumNonStack.itemLettuceLeaf) }));
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSandwichChickenGrilled, 2), new Object[]
                {
                                "BB",
                                "CL",
                                "BB",
                                ...
                                EHandler.getItem(EnumBaseItem.sliceBread),
                                'C',
                                EHandler.getItem(EnumBaseFood.foodChickenGrilled),
                                'L',
                                EHandler.getItem(EnumNonStack.itemLettuceLeaf) }));
        CraftingManager.getInstance()
                .getRecipeList()
                .add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSalad, 2), new Object[]
                {
                                "TCT",
                                "LLL",
                                "B B",
        ...
        { "B B", "SSS", " C ", 'C', EHandler.getItem(EnumNonStack.cookedCake), 'B', EHandler.getItem(EnumBaseFood.foodBerryStrawberry), 'S', Item.sugar }));
        // Blocks
        ...
        { "III", "BAB", "BFB", 'I', Item.ingotIron, 'F', Block.furnaceIdle, 'B', Item.brick, 'A', EHandler.getItem(EnumBaseItem.sheetAluminum) }));
        ...
        { "S S", " S ", "S S", 'S', EHandler.getItem(EnumBaseItem.sheetAluminum) }));
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolAxe), new Object[]
        { "xx", "xy", " y", 'x', "ingotAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolHoe), new Object[]
        { "xx", " y", " y", 'x', "ingotAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolShovel), new Object[]
        { "x", "y", "y", 'x', "ingotAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolPickaxe), new Object[]
        { "xxx", " y ", " y ", 'x', "ingotAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolSword), new Object[]
        { "x", "x", "y", 'x', "ingotAluminum", 'y', "stickWood" }));

        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolAxe), new Object[]
        { "xx", "xy", " y", 'x', "ingotAluminium", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolHoe), new Object[]
        { "xx", " y", " y", 'x', "ingotAluminium", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolShovel), new Object[]
        { "x", "y", "y", 'x', "ingotAluminium", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolPickaxe), new Object[]
        { "xxx", " y ", " y ", 'x', "ingotAluminium", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolSword), new Object[]
        { "x", "x", "y", 'x', "ingotAluminium", 'y', "stickWood" }));

        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolAxe), new Object[]
        { "xx", "xy", " y", 'x', "naturalAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolHoe), new Object[]
        { "xx", " y", " y", 'x', "naturalAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolShovel), new Object[]
        { "x", "y", "y", 'x', "naturalAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolPickaxe), new Object[]
        { "xxx", " y ", " y ", 'x', "naturalAluminum", 'y', "stickWood" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.toolSword), new Object[]
        { "x", "x", "y", 'x', "naturalAluminum", 'y', "stickWood" }));
    }
    ...
    private static void addShapeless()
    {
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.dustFlour), new Object[]
        ...
        { EHandler.getItem(EnumBaseItem.ingotSugar) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.ingotSugar, 4), new Object[]
        { new ItemStack(ModBlocks.blockSugar) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.ingotAluminum, 9), new Object[]
        { new ItemStack(ModBlocks.blockAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseFood.foodCheese, 9), new Object[]
        { new ItemStack(ModBlocks.blockCheese) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.ingotButter, 9), new Object[]
        { new ItemStack(ModBlocks.blockButter) }));
        // Cooking Items
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.itemChocolateChips), new Object[]
        { EHandler.getItem(EnumNonStack.globChocolate), Item.sugar }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.globDough), new Object[]
        { Item.bucketWater, "dustWheat", "dustWheat", "dustWheat" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.globDoughCorn), new Object[]
        { Item.bucketWater, "dustWheat", "dustWheat", EHandler.getItem(EnumUncookedFood.uncookedSeedsCorn), EHandler.getItem(EnumUncookedFood.uncookedSeedsCorn) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumNonStack.bowlBatter), new Object[]
        { EHandler.getItem(EnumNonStack.bowl), "dustWheat", "dustWheat", "dustWheat", Item.sugar, Item.egg, Item.bucketMilk }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumNonStack.bowlPumpkinFilling), new Object[]
        { EHandler.getItem(EnumBaseItem.rawPumpkinMash), Item.bucketMilk, Item.sugar, EHandler.getItem(EnumBaseItem.rawPumpkinMash), EHandler.getItem(EnumNonStack.bowl) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumNonStack.bowlCookieDough), new Object[]
        { Item.sugar, "dustWheat", EHandler.getItem(EnumBaseItem.dustFlour), Item.bucketMilk, Item.egg, EHandler.getItem(EnumNonStack.bowl) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumNonStack.bowlCookieDoughChocolateChip), new Object[]
        { EHandler.getItem(EnumNonStack.bowlCookieDough), EHandler.getItem(EnumBaseItem.itemChocolateChips), Item.sugar }));
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumNonStack.bowlCookieDoughSugar), new Object[]
        { EHandler.getItem(EnumNonStack.bowlCookieDough), Item.sugar }));
