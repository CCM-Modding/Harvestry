...
final class RecipesOven {
    ...
    private static void registerRecipes() {
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedBread), new ItemStack(Item.bread),
                EnumToItemStack.getItemIS(EnumItemSixteen.panBread));
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPotato),
        ...
        OvenRecipes.cooking().addCookingRecipe(
                ...
                new ItemStack(Item.pumpkinPie), EnumToItemStack.getItemIS(EnumItemSixteen.panPie));
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPieApple),
        ...
        OvenRecipes.cooking().addCookingRecipe(
                ...
                EnumToItemStack.getItemIS(EnumItemSixteen.panPie));
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedCookies),
        ...
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPizza),
                EnumToItemStack.getItemIS(EnumFood.foodPizza));
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedMeatBall),
                EnumToItemStack.getItemIS(EnumItemSixteen.cookedMeatBall));
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedMeatPatty),
                EnumToItemStack.getItemIS(EnumItemSixteen.cookedMeatPatty));
        OvenRecipes.cooking().addCookingRecipe(
                EnumToItemStack.getItemIS(EnumUncookedFood.uncookedNoodles),
        ...
        OvenRecipes.cooking().addCookingRecipe(EnumToItemStack.getItemIS(EnumItem.dustBeef),
                EnumToItemStack.getItemIS(EnumItemSixteen.cookedDustMeat));
        OvenRecipes.cooking().addCookingRecipe(EnumToItemStack.getItemIS(EnumFood.foodEggs),
