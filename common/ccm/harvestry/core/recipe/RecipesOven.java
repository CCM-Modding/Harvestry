...
final class RecipesOven {
	...
	private void registerRecipes() {
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedBread),
											new ItemStack(Item.bread),
											EnumToItemStack.getItemIS(EnumItemSixteen.panBread));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPotato),
		...
		OvenRecipes.instance()
					.addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPieBerryCherry),
		...
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedCookiesSugar),
											...
											EnumToItemStack.getItemIS(EnumItemSixteen.sheetCookie));
		OvenRecipes.instance()
					.addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedCookiesChocolateChip),
								EnumToItemStack.getItemIS(EnumFood.foodCookieChocolateChip, 16),
								EnumToItemStack.getItemIS(EnumItemSixteen.sheetCookie));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPizzaCheese),
											EnumToItemStack.getItemIS(EnumFood.foodPizzaCheese));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPizza),
											EnumToItemStack.getItemIS(EnumFood.foodPizza));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedMeatBall),
											EnumToItemStack.getItemIS(EnumItemSixteen.cookedMeatBall));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedMeatPatty),
											EnumToItemStack.getItemIS(EnumItemSixteen.cookedMeatPatty));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedNoodles),
											EnumToItemStack.getItemIS(EnumItemSixteen.cookedNoodles));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumUncookedFood.uncookedTortilla),
											EnumToItemStack.getItemIS(EnumItemSixteen.itemTortilla));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumItem.dustBeef),
											EnumToItemStack.getItemIS(EnumItemSixteen.cookedDustMeat));
		OvenRecipes.instance().addRecipe(	EnumToItemStack.getItemIS(EnumFood.foodEggs),
											new ItemStack(Item.egg));
		OvenRecipes.instance().addRecipe(	new ItemStack(Block.pumpkin),
											EnumToItemStack.getItemIS(EnumItem.rawPumpkinMash, 4));
	}
}