...
final class RecipesOven {
    ...
    private static void registerRecipes() {
        ...
        OvenRecipes.cooking().addCookingRecipe(EHandler.getItem(UncookedFoodEnum.uncookedCake), EHandler.getItem(ItemEnumSixteen.cookedCake), EHandler.getItem(ItemEnumSixteen.panCake));
        ...
        OvenRecipes.cooking().addCookingRecipe(EHandler.getItem(UncookedFoodEnum.uncookedPieApple), EHandler.getItem(FoodEnum.foodPieApple), EHandler.getItem(ItemEnumSixteen.panPie));
        OvenRecipes.cooking().addCookingRecipe(EHandler.getItem(UncookedFoodEnum.uncookedPieBerryBlue), EHandler.getItem(FoodEnum.foodBerryBlue), EHandler.getItem(ItemEnumSixteen.panPie));
        OvenRecipes.cooking().addCookingRecipe(EHandler.getItem(UncookedFoodEnum.uncookedPieBerryCherry), EHandler.getItem(FoodEnum.foodPieBerryCherry), EHandler.getItem(ItemEnumSixteen.panPie));
        OvenRecipes.cooking().addCookingRecipe(EHandler.getItem(UncookedFoodEnum.uncookedCookies), EHandler.getItem(FoodEnum.foodCookie, 16), EHandler.getItem(ItemEnumSixteen.sheetCookie));
        OvenRecipes.cooking().addCookingRecipe(EHandler.getItem(UncookedFoodEnum.uncookedCookiesSugar), EHandler.getItem(FoodEnum.foodCookieSugar, 16), EHandler.getItem(ItemEnumSixteen.sheetCookie));
        OvenRecipes.cooking().addCookingRecipe(EHandler.getItem(UncookedFoodEnum.uncookedCookiesChocolateChip), EHandler.getItem(FoodEnum.foodCookieChocolateChip, 16), EHandler.getItem(ItemEnumSixteen.sheetCookie));
