...
final class RecipesOven extends RecipeRegistry {
    ...
    void registerRecipes() {
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedBread),
                          new ItemStack(Item.bread),
                          EnumToItemStack.getItemIS(EnumItemSixteen.panBread));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPotato),
                          new ItemStack(Item.bakedPotato));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedCake),
                          EnumToItemStack.getItemIS(EnumItemSixteen.cookedCake),
                          EnumToItemStack.getItemIS(EnumItemSixteen.panCake));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPiePumpkin),
                          new ItemStack(Item.pumpkinPie),
                          EnumToItemStack.getItemIS(EnumItemSixteen.panPie));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPieApple),
        ...
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPieBerryCherry),
                          EnumToItemStack.getItemIS(EnumFood.foodPieBerryCherry),
                          EnumToItemStack.getItemIS(EnumItemSixteen.panPie));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedCookies),
                          EnumToItemStack.getItemIS(EnumFood.foodCookie, 16),
                          EnumToItemStack.getItemIS(EnumItemSixteen.sheetCookie));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedCookiesSugar),
                          EnumToItemStack.getItemIS(EnumFood.foodCookieSugar, 16),
                          EnumToItemStack.getItemIS(EnumItemSixteen.sheetCookie));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedCookiesChocolateChip),
                          EnumToItemStack.getItemIS(EnumFood.foodCookieChocolateChip, 16),
                          EnumToItemStack.getItemIS(EnumItemSixteen.sheetCookie));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPizzaCheese),
                          EnumToItemStack.getItemIS(EnumFood.foodPizzaCheese));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedPizza),
                          EnumToItemStack.getItemIS(EnumFood.foodPizza));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedMeatBall),
                          EnumToItemStack.getItemIS(EnumItemSixteen.cookedMeatBall));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedMeatPatty),
                          EnumToItemStack.getItemIS(EnumItemSixteen.cookedMeatPatty));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedNoodles),
                          EnumToItemStack.getItemIS(EnumItemSixteen.cookedNoodles));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumUncookedFood.uncookedTortilla),
                          EnumToItemStack.getItemIS(EnumItemSixteen.itemTortilla));
        recipes.addRecipe(EnumToItemStack.getItemIS(EnumItem.dustBeef),
