...
final class RecipesGrinder
{
    ...
    private static void registerRecipes()
    {
        ...
        // GrinderRecipes.grinding().addGrinding(new ItemStack(ModBlocks.oreSalt),
        // EHandler.getItem(EnumBaseItem.dustSalt, 9));
        ...
        // temp recipes
        GrinderRecipes.grinding().addGrinding(EHandler.getItem(FoodEnum.foodTomato), EHandler.getItem(ItemEnumSixteen.bowlTomato));
