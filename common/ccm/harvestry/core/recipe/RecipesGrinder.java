...
final class RecipesGrinder {
    ...
    private void registerRecipes() {
        ...
        GrinderRecipes.instance().addRecipe(new ItemStack(Item.dyePowder, 1, 3), EnumToItemStack.getItemIS(EnumItemSixteen.globChocolate));
        ...
        GrinderRecipes.instance().addRecipe(EnumToItemStack.getItemIS(EnumItem.sliceCheese), EnumToItemStack.getItemIS(EnumItem.dustCheese));
        GrinderRecipes.instance().addRecipe(EnumToItemStack.getItemIS(EnumFood.foodCheese), EnumToItemStack.getItemIS(EnumItem.dustCheese, 6));
        GrinderRecipes.instance().addRecipe(EnumToItemStack.getItemIS(EnumItemSixteen.itemLettuceLeaf), EnumToItemStack.getItemIS(EnumItem.dustLettuce));
        // GrinderRecipes.grinding().addGrinding(EHandler.getItem(OresEnum.oreSalt),
        // EHandler.getItem(ItemEnum.dustSalt, 9));
        GrinderRecipes.instance().addRecipe(new ItemStack(Block.wood), EnumToItemStack.getItemIS(EnumItem.rawWood, 4));
        GrinderRecipes.instance().addRecipe(new ItemStack(Block.planks), EnumToItemStack.getItemIS(EnumItem.rawWood));
        GrinderRecipes.instance().addRecipe(EnumToItemStack.getItemIS(EnumFood.foodSeedsPeanuts), EnumToItemStack.getItemIS(EnumItemSixteen.globPB));
        GrinderRecipes.instance().addRecipe(Item.bone, new ItemStack(Item.dyePowder, 4, 15));
        GrinderRecipes.instance().addRecipe(EnumToItemStack.getItemIS(EnumFood.foodTomato), EnumToItemStack.getItemIS(EnumItemSixteen.globTomato));
        GrinderRecipes.instance().addRecipe(EnumToItemStack.getItemIS(EnumItem.seedsMustard), EnumToItemStack.getItemIS(EnumItemSixteen.rawMustard));
