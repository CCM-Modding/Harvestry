...
public final class ModBlocks {
    ...
    public static void init() {
        ...
        ModBlocks.blockSugar = new BaseBlock(Properties.blockSugarID)
                .setUnlocalizedName(BlockNames.blockSugar).setHardness(1.0F);
        ModBlocks.blockAluminum = new BaseBlock(Properties.blockAluminumID)
                .setUnlocalizedName(BlockNames.blockAluminum).setHardness(3.0F);
        ...
        ModBlocks.blockGrinderRunning = new BlockGrinder(Properties.blockGrinderRunningID, true)
                .setUnlocalizedName(BlockNames.blockGrinder).setHardness(3.0F);
        ModBlocks.blockOven = new BlockOven(Properties.blockOvenID, false)
                .setUnlocalizedName(BlockNames.blockOven).setHardness(3.0F);
        ...
        ModBlocks.blockCheese = new BaseBlock(Properties.blockCheeseID)
                .setUnlocalizedName(BlockNames.blockCheese).setHardness(1.0F);
        ModBlocks.blockButter = new BaseBlock(Properties.blockButterID)
                .setUnlocalizedName(BlockNames.blockButter).setHardness(1.0F);
        ModBlocks.blockBarrel = new BlockBarrel(Properties.blockBarrelID)
                .setUnlocalizedName(BlockNames.blockBarrel).setHardness(3.0F);
        ModBlocks.blockCabinet = new BlockCabinet(Properties.blockCabinetID)
                .setUnlocalizedName(BlockNames.blockCabinet).setHardness(3.0F);
        ModBlocks.blockGrill = new BlockGrill(Properties.blockGrillID, false)
                .setUnlocalizedName(BlockNames.blockGrill).setHardness(3.0F);
