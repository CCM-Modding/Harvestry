...
public class BlockGrinder extends BaseContainerBlock
{
    ...
    public void registerIcons(final IconRegister iconRegister)
    {
        ...
        this.blockIcon = iconRegister.registerIcon(this.isActive ? TextureHelper.getTextureFromName(this.getUnlocalizedName2() + "SideOn", Locations.TEXTURE + "machine/")
                                                                : TextureHelper.getTextureFromName(this.getUnlocalizedName2() + "SideOff", Locations.TEXTURE + "machine/"));
    }
}