...
public class BlockGrinder extends BaseContainerBlock {
    ...
    public void registerIcons(final IconRegister iconRegister) {
        ...
        blockIcon = iconRegister.registerIcon(isActive
                                                      ? TextureHelper.getTextureFromName(getUnlocalizedName2() + "SideOn", Locations.TEXTURE + "machine/")
                                                      : TextureHelper.getTextureFromName(getUnlocalizedName2() + "SideOff", Locations.TEXTURE + "machine/"));
    }
}