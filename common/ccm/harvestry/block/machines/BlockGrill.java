...
public class BlockGrill extends BaseContainerBlock {
    ...
    public static void updateBlockState(final boolean working, final World world, final int x,
        ...
        if (working)
            world.setBlock(x, y, z, ModBlocks.blockGrillRunning.blockID);
        else
            world.setBlock(x, y, z, ModBlocks.blockGrill.blockID);
     ...
     * @param id
     */
    public BlockGrill(final int id, final boolean active) {
    ...
    public ItemStack getPickBlock(final MovingObjectPosition target, final World world,
        ...
        return new ItemStack(Properties.blockGrillID, 1, 0);
    }

    @Override
    public int idDropped(final int meta, final Random random, final int fortune) {
        return Properties.blockGrillID;
    }
    ...
    public boolean onBlockActivated(final World world, final int x, final int y, final int z,
        ...
        if (super.onBlockActivated(world, x, y, z, player, wut, clockZ, clockZ, clockZ)) {
            ...
            if (grill != null) {
                GUIHandler.openGui(Harvestry.instance, TileConstants.GRILL_GUID, player, world, x,
                        y, z);
                return true;
            } else
                return false;
    ...
    public void registerIcons(final IconRegister iconRegister) {
        ...
        this.blockIcon = iconRegister.registerIcon(TextureHelper.getTextureFromName(
                this.getUnlocalizedName2() + "Side", Locations.TEXTURE + "machine/"));
        ...
        this.frontIcon = iconRegister.registerIcon(this.isActive ? TextureHelper
                .getTextureFromName(this.getUnlocalizedName2() + "FrontOn", Locations.TEXTURE
                        + "machine/") : TextureHelper.getTextureFromName(this.getUnlocalizedName2()
                + "FrontOff", Locations.TEXTURE + "machine/"));
    }
}