...
public class TileOven extends TileBase {
    ...
    public void readFromNBT(final NBTTagCompound nbt) {
        ...
        this.setInventory(InventoryHelper.readInventoryFromNBT(
                nbt.getTagList(TileConstants.INVENTORY), TileOven.invSize));
    }
    ...
    public void updateEntity() {
        if (!this.worldObj.isRemote)
            if (this.canCook()) {
                ...
                BlockOven.updateBlockState(true, this.worldObj, this.xCoord, this.yCoord,
                        this.zCoord);
                ++this.cookTime;
                if (this.cookTime == 200) {
                    ...
                    BlockOven.updateBlockState(false, this.worldObj, this.xCoord, this.yCoord,
                            this.zCoord);
                }
            } else {
                this.cookTime = 0;
