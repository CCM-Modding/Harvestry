...
public class TileGrill extends TileBase
{
    ...
    public TileGrill()
    {
        super(invSize, TileConstants.GRILL_UNLOCALIZED);
    }
    ...
    public boolean canGrill()
    {
        if (this.hasFuel()){
            if (this.recipe.getGrillingResult(this.inventory[0]) != null){
                final ItemStack itemstack = this.recipe.getGrillingResult(this.inventory[0]).getOutput1();
                ...
                if (this.recipe.getGrillingResult(this.inventory[0]).hasSecondOutput()){
                    final ItemStack itemstack2 = this.recipe.getGrillingResult(this.inventory[0]).getOutput2();
    ...
    /**
     * Turn one item from the grill source stack into the appropriate cooked item
    ...
    public void updateEntity()
    {
        if (!this.worldObj.isRemote){
            if (this.canGrill()){
                ...
                BlockGrill.updateBlockState(true, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                ++this.grillTime;
                if (this.grillTime == 200){
                    this.grillTime = 0;
                    this.grillItem();
                    this.onInventoryChanged();
                    BlockGrill.updateBlockState(false, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }else{
                this.grillTime = 0;
                BlockGrill.updateBlockState(false, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
