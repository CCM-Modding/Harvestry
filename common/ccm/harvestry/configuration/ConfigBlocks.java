...
final class ConfigBlocks extends Config {
    ...
    protected static void configBlocks(final AdvConfiguration config) {
        ...
        Properties.blockGrinderID = config.getBlock(BlockNames.blockGrinder, Properties.blockID)
                .getInt();
        Properties.blockGrinderRunningID = config.getBlock(BlockNames.blockGrinder + "Active",
                Properties.blockID).getInt();
        Properties.blockSugarID = config.getBlock(BlockNames.blockSugar, Properties.blockID)
                .getInt();
        Properties.blockAluminumID = config.getBlock(BlockNames.blockAluminum, Properties.blockID)
                .getInt();
        Properties.blockRollerID = config.getBlock(BlockNames.blockRoller, Properties.blockID)
                .getInt();
        Properties.blockRollerRunningID = config.getBlock(BlockNames.blockRoller + "Active",
                Properties.blockID).getInt();
        Properties.blockCounterID = config.getBlock(BlockNames.blockCounter, Properties.blockID)
                .getInt();
        Properties.blockCheeseID = config.getBlock(BlockNames.blockCheese, Properties.blockID)
                .getInt();
        Properties.blockButterID = config.getBlock(BlockNames.blockButter, Properties.blockID)
                .getInt();
        Properties.blockBarrelID = config.getBlock(BlockNames.blockBarrel, Properties.blockID)
                .getInt();
        Properties.blockCabinetID = config.getBlock(BlockNames.blockCabinet, Properties.blockID)
                .getInt();
        Properties.blockGrillID = config.getBlock(BlockNames.blockGrill, Properties.blockID)
                .getInt();
        ...
        Properties.cropLettuceID = config.getBlock(BlockNames.cropLettuce, Properties.blockID)
                .getInt();
