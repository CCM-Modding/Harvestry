...
final class OreDictionaryRegistry {
    ...
    protected static void oreDictionary() {
        ...
        OreDictionary.registerOre("naturalAluminum", EnumToItemStack.getItemIS(EnumItem.ingotAluminum));
        
        OreDictionary.registerOre("ingotAluminium", EnumToItemStack.getItemIS(EnumItem.ingotAluminum));
        
        OreDictionary.registerOre("ingotAluminum", EnumToItemStack.getItemIS(EnumItem.ingotAluminum));
        
        OreDictionary.registerOre("dustAluminium", EnumToItemStack.getItemIS(EnumItem.dustAluminum));
