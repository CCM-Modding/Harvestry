...
final class WorldRegistry
{
    ...
    {
        CCMLogger.finest(Harvestry.instance, "Registering World Generation for Aluminum");
    ...
    {
        CCMLogger.finest(Harvestry.instance, "Registering World Generation for Salt");
