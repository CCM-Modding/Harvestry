...
public class BaseItem extends BaseItemClass {
    ...
    public String getUnlocalizedName(final ItemStack itemStack) {
        ...
        case 1:
            this.setUnlocalizedName(BaseItem.currentNonStack[itemStack.getItemDamage()].name());
            return super.getUnlocalizedName();
        case 2:
            this.setUnlocalizedName(BaseItem.currentUncookedFood[itemStack.getItemDamage()].name());
            return super.getUnlocalizedName();
        default:
            return null;
        }
