...
public final class ModItems {
    ...
    public static void init() {
        ...
        ModItems.toolCuttingBoard = new BaseUseableItem(Properties.toolCuttingBoardID, EnumModTool.toolCuttingBoard.duration).setUnlocalizedName(EnumModTool.toolCuttingBoard.name());
