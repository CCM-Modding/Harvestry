...
final class RecipesCrafting {
    ...
    private static void addShaped() {
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.heCopper), new Object[] { " S ", "SIS", " S ", 'S', EHandler.getItem(EnumBaseItem.sheetCopper), 'I', new ItemStack(ModItems.heTin) }));
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottle, 5), new Object[] { " G ", "G G", "GGG", 'G', Block.thinGlass }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottleGlass, 4), new Object[] { "G G", "GGG", 'G', Block.thinGlass }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottleMilk, 3), new Object[] { " G ", "G G", " G ", 'G', Block.thinGlass }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.bottlePitcher, 2), new Object[] { "G G", "G G", "GGG", 'G', Block.thinGlass }));

        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseItem.itemKetchup), new Object[] { "T", "B", 'T', EHandler.getItem(EnumNonStack.bowlTomato), 'B', EHandler.getItem(EnumNonStack.bottle) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseItem.itemMustard), new Object[] { "T", "B", 'T', EHandler.getItem(EnumNonStack.rawMustard), 'B', EHandler.getItem(EnumNonStack.bottle) }));
        // Uncooked Food
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPotato), new Object[] { "B", "P", 'B', Item.potato, 'P', EHandler.getItem(EnumBaseItem.foilAluminum) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedBread), new Object[] { "B", "P", 'B', EHandler.getItem(EnumBaseItem.globDough), 'P', EHandler.getItem(EnumNonStack.panBread) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedCookies), new Object[] { "B", "P", 'B', EHandler.getItem(EnumNonStack.bowlCookieDough), 'P', EHandler.getItem(EnumNonStack.sheetCookie) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedCookiesChocolateChip), new Object[] { "B", "P", 'B', EHandler.getItem(EnumNonStack.bowlCookieDoughChocolateChip), 'P', EHandler.getItem(EnumNonStack.sheetCookie) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedCookiesSugar), new Object[] { "B", "P", 'B', EHandler.getItem(EnumNonStack.bowlCookieDoughSugar), 'P', EHandler.getItem(EnumNonStack.sheetCookie) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPiePumpkin), new Object[] { "B", "P", 'B', EHandler.getItem(EnumNonStack.bowlPumpkinFilling), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPieApple), new Object[] { "B", "P", 'B', EHandler.getItem(EnumBaseItem.sliceApple), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPieBerryBlue), new Object[] { "B", "P", 'B', EHandler.getItem(EnumBaseFood.foodBerryBlue), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPieBerryCherry), new Object[] { "B", "P", 'B', EHandler.getItem(EnumBaseFood.foodBerryCherry), 'P', EHandler.getItem(EnumNonStack.panPieCrust) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedPizzaCheese), new Object[] { "B", "P", 'B', EHandler.getItem(EnumBaseItem.dustCheese), 'P', EHandler.getItem(EnumNonStack.rawPizzaSauce) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedMeatBall, 4), new Object[] { "BB", "BB", 'B', EHandler.getItem(EnumBaseItem.dustBeef) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumUncookedFood.uncookedMeatPatty, 2), new Object[] { "BBB", 'B', EHandler.getItem(EnumBaseItem.dustBeef) }));
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumNonStack.rawPizzaSauce), new Object[] { "B", "P", 'B', EHandler.getItem(EnumNonStack.bowlTomato), 'P', EHandler.getItem(EnumNonStack.rawPizza) }));
        // Food
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodBoxOFries, 4), new Object[] { "FSF", "PFP", "PPP", 'P', Item.paper, 'F', EHandler.getItem(EnumNonStack.friedFries), 'S', EHandler.getItem(EnumBaseItem.dustSalt) }));
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(EHandler.getItem(EnumBaseFood.foodSpaghetti, 3), new Object[] { "MMM", "SSS", "NNN", 'M', EHandler.getItem(EnumNonStack.cookedMeatBall), 'N', EHandler.getItem(EnumNonStack.cookedNoodles), 'T', EHandler.getItem(EnumNonStack.bowlTomato) }));
        ...
        // 'I', Item.ingotIron,
        // 'S', EHandler.getItem(EnumBaseItem.sheetAluminum), 'N',
        // Block.netherrack }));
    ...
    private static void addShapeless() {
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumBaseItem.sliceCheese, 6), new Object[] { EHandler.getItem(EnumBaseFood.foodCheese) }));
        // Cooking Items
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumNonStack.panPieCrust), new Object[] { EHandler.getItem(EnumNonStack.panPie), EHandler.getItem(EnumBaseItem.globDough) }));
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(EHandler.getItem(EnumNonStack.bowlPumpkinFilling), new Object[] { EHandler.getItem(EnumBaseItem.rawPumpkinMash), Item.bucketMilk, Item.sugar, EHandler.getItem(EnumBaseItem.rawPumpkinMash) }));
